...
public class MainForm : System.Windows.Forms.Form
{
    ...
    public MainForm()
    {
        ...
        try
        {
            ...
            using ResourceManager rmSession = new();
            IEnumerable<string> validResources = rmSession.Find( "(GPIB|TCPIP|USB)?*INSTR" );
...
"RQ button.";
    ...
    private void OpenButton_Click( object sender, System.EventArgs e )
    {
        ...
        {
            using ResourceManager rmSession = new();
            this._mbSession = ( MessageBasedSession ) rmSession.Open( this._resourceNameComboBox.Text );
    ...
    private void OnServiceRequest( object sender, VisaEventArgs e )
    {
        try
        {
            MessageBasedSession messageBasedSession = ( MessageBasedSession ) sender;
